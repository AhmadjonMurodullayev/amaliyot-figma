        ...
        <Stack direction={"row"} spacing={2}>
          ...
          >
            ...
            <Accordion>
              ...
              <AccordionDetails>
                <FormGroup>
                  {["32 ГБ, слот для карты памяти", "128GB", "256GB"].map(
                    (ram) => (
                      <FormControlLabel
                        key={ram}
                        control={<Checkbox />}
              ...
              <AccordionDetails>
                <FormGroup>
                  {[
                    ...
                    "NFC, Wi-Fi, Bluetooth 5.1",
                    "NFC, Wi-Fi, Bluetooth 5.2",
                    "NFC, Wi-Fi, Bluetooth 5.3",
                    "NFC, Wi-Fi, Bluetooth 5.4",
                  ].map((ram) => (
                    <FormControlLabel
                      key={ram}
                      control={<Checkbox />}
